...
{% block extrastyle %}
    {{ block.super }}
    <link rel="stylesheet" type="text/css" href="{{ STATIC_UR }}css/forms.css" />
...
{% block extrahead %}
    ...
    <script type="text/javascript" src="{{ STATIC_UR }}js/core.js"></script>
    <script type="text/javascript" src="{{ STATIC_UR }}js/admin/CollapsedFieldsets.js"></script>
{% endblock %}
